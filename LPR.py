...
def angleBetweenChars(firstChar, secondChar):
    adjacent = float(abs(firstChar.centerX - secondChar.centerX))                          #sides to calculate the angle
...
for filename in os.listdir('/content/drive/My Drive/CAR1'):
      print(filename)
      print(os.path.abspath(filename))
      img = cv2.imread('/content/drive/My Drive/CAR1/'+filename)
...
#11
      for i in range(0, len(contours)):
          cv2.drawContours(imageContours, contours, i, (255, 255, 255))             #drawing contours
          possibleChar = ifChar(contours[i])                                        #maybe to check 
          if checkIfChar(possibleChar) is True:
              countOfPossibleChars = countOfPossibleChars + 1   
              possibleChars.append(possibleChar)
      print("image countours")
      ...
      for c in cnts:
          ...
          if (area > 1000) and (area < 100000):
              ...
              ROI = img[y:y+h, x:x+w]
              cv2_imshow(ROI)
              io.imsave('/content/drive/My Drive/ROI/ROI_{}_{}.png'.format(ROI_number,count), ROI)
              ROI_number += 1
      print("")
      print(count)
      cv2_imshow(img)
...
for filename in os.listdir('/content/drive/My Drive/ROI2/imagess'):
    ...
    for ((startX, startY, endX, endY), text) in results:
        ...
        cv2.rectangle(output, (startX, startY), (endX, endY),
            (0, 0, 255), 2)
        cv2.putText(ou tput, text, (startX, startY - 20),
